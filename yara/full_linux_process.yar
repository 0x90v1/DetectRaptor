...
rule VOLEXITY_Apt_Malware_Linux_Disgomoji_Modules : TRANSPARENTJASMINE FILE MEMORY {
    meta:
		...
		source_url = "https://github.com/volexity/threat-intel/blob/5fd84467b3ecfddb0db2f2b9ae747d70c6d56492/2024/2024-06-13 DISGOMOJI/indicators/rules.yar#L1-L24"
		license_url = "https://github.com/volexity/threat-intel/blob/5fd84467b3ecfddb0db2f2b9ae747d70c6d56492/LICENSE.txt"
...
rule VOLEXITY_Apt_Malware_Linux_Disgomoji_Loader : TRANSPARENTJASMINE FILE MEMORY {
    meta:
		...
		modified = "2024-07-05"
		reference = "TIB-20240229"
		source_url = "https://github.com/volexity/threat-intel/blob/5fd84467b3ecfddb0db2f2b9ae747d70c6d56492/2024/2024-06-13 DISGOMOJI/indicators/rules.yar#L25-L47"
		license_url = "https://github.com/volexity/threat-intel/blob/5fd84467b3ecfddb0db2f2b9ae747d70c6d56492/LICENSE.txt"
...
rule VOLEXITY_Apt_Malware_Linux_Disgomoji_Debug_String : TRANSPARENTJASMINE FILE MEMORY {
    meta:
		...
		modified = "2024-11-27"
		reference = "TIB-20240229"
		source_url = "https://github.com/volexity/threat-intel/blob/5fd84467b3ecfddb0db2f2b9ae747d70c6d56492/2024/2024-06-13 DISGOMOJI/indicators/rules.yar#L48-L71"
		license_url = "https://github.com/volexity/threat-intel/blob/5fd84467b3ecfddb0db2f2b9ae747d70c6d56492/LICENSE.txt"
...
rule VOLEXITY_Apt_Malware_Linux_Disgomoji_2 : TRANSPARENTJASMINE FILE MEMORY {
    meta:
		...
		modified = "2024-07-05"
		reference = "TIB-20240229"
		source_url = "https://github.com/volexity/threat-intel/blob/5fd84467b3ecfddb0db2f2b9ae747d70c6d56492/2024/2024-06-13 DISGOMOJI/indicators/rules.yar#L72-L103"
		license_url = "https://github.com/volexity/threat-intel/blob/5fd84467b3ecfddb0db2f2b9ae747d70c6d56492/LICENSE.txt"
...
rule VOLEXITY_Apt_Malware_Linux_Disgomoji_1 : TRANSPARENTJASMINE FILE MEMORY {
    meta:
		...
		modified = "2024-07-05"
		reference = "TIB-20240229"
		source_url = "https://github.com/volexity/threat-intel/blob/5fd84467b3ecfddb0db2f2b9ae747d70c6d56492/2024/2024-06-13 DISGOMOJI/indicators/rules.yar#L104-L131"
		license_url = "https://github.com/volexity/threat-intel/blob/5fd84467b3ecfddb0db2f2b9ae747d70c6d56492/LICENSE.txt"
...
rule VOLEXITY_Apt_Malware_Macos_Vpnclient_Cc_Oct23 : CHARMINGCYPRESS FILE MEMORY {
    meta:
		...
		source_url = "https://github.com/volexity/threat-intel/blob/5fd84467b3ecfddb0db2f2b9ae747d70c6d56492/2024/2024-02-13 CharmingCypress/rules.yar#L246-L272"
		license_url = "https://github.com/volexity/threat-intel/blob/5fd84467b3ecfddb0db2f2b9ae747d70c6d56492/LICENSE.txt"
...
rule VOLEXITY_Apt_Malware_Elf_Catchdns_Aug20_Memory : DRIFTINGBAMBOO FILE MEMORY {
    meta:
		...
		modified = "2025-06-19"
		reference = "https://github.com/volexity/threat-intel"
		source_url = "https://github.com/volexity/threat-intel/blob/5fd84467b3ecfddb0db2f2b9ae747d70c6d56492/2024/2024-08-02 StormBamboo/rules.yar#L309-L383"
		license_url = "https://github.com/volexity/threat-intel/blob/5fd84467b3ecfddb0db2f2b9ae747d70c6d56492/LICENSE.txt"
...
rule VOLEXITY_Apt_Malware_Elf_Verdantbamboo_Paths : VERDANTBAMBOO FILE MEMORY {
    meta:
		...
		modified = "2026-01-27"
		reference = "https://github.com/volexity/threat-intel"
		source_url = "https://github.com/volexity/threat-intel/blob/5fd84467b3ecfddb0db2f2b9ae747d70c6d56492/2026/2026-06-04 VerdantBamboo/rules.yar#L32-L54"
		license_url = "https://github.com/volexity/threat-intel/blob/5fd84467b3ecfddb0db2f2b9ae747d70c6d56492/LICENSE.txt"
